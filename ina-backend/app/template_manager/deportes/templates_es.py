# Templates en Español - Deportes
"""
Templates de respuesta en español para consultas relacionadas con Deportes.
Incluye talleres deportivos, gimnasio CAF, selecciones, becas deportivas, etc.
"""
...
✅ **Talleres Masculinos:** Fútbol
✅ **Talleres Femeninos:** Futbolito
📅 **Duración:** Semestral, inscripciones al inicio de cada periodo
✅ **Requisitos:** Estudiante regular, certificado médico, inscripción en Vivo Duoc
...
📅 **Notas:** Horarios sujetos a cambios, asistencia mínima 85%
...
✅ **Modalidad:** Online, gratuito, máximo 2 talleres por semestre
...
📅 **Postulaciones:** 1-15 Marzo (1S) / 1-15 Agosto (2S)
🔗 **Postular:** https://beneficios.duoc.cl/deportes
🔗 **Más información:** https://deportes.duoc.cl/becas
...
• **Sábados:** 9:00-14:00
• **Domingos/Festivos:** Cerrado
🏋️ **Uso Libre (sin reserva):**
• L-V: 8:00-10:00 / 14:00-16:00 / 18:00-20:00
• Sábados: 9:00-11:00 / 12:00-14:00
📅 **Clases Dirigidas (con reserva):**
• **Spinning:** Mar/Jue 18:00-19:00
• **Yoga:** Lun/Mie 17:00-18:00
• **Crossfit:** Mar/Jue 19:00-20:00
• **Pilates:** Lun/Vie 12:00-13:00
⚠️ **Consideraciones Especiales:**
• Horarios reducidos durante exámenes
• Cierre técnico último viernes de mes
• Verificar disponibilidad en feriados largos
🔗 **Consultar disponibilidad:** https://vivo.duoc.cl/caf
📞 **Info:** +56 2 2360 6470
💡 *Reserve clases dirigidas con anticipación para asegurar cupo*
""",
...
📝 **Desinscripción de Optativos Deportivos**
**Proceso para cancelar tu inscripción en actividades deportivas.**
✅ **Opciones de Desinscripción:**
• **Retiro temprano:** Hasta 2ª semana de clases
• **Retiro con causa justa:** Médica o académica
• **Cambio de taller:** A otro deporte disponible
📅 **Plazos Importantes:**
• **Sin penalización:** Antes del 15 de marzo/agosto
• **Con documentación:** Certificado médico o académico
• **Después del plazo:** Queda registro de participación
✅ **Proceso de Retiro:**
1. **Solicita formulario** en Punto Estudiantil
2. **Presenta justificación** (si corresponde)
3. **Firma autorización** de retiro
4. **Confirmación** vía email institucional
📞 **Contacto:** deportes_pnorte@duoc.cl
🔗 **Gestión online:** https://vivo.duoc.cl
💡 *Puedes inscribirte en otro taller según disponibilidad*
""",

    "optativos_deportivos_nota": """📊 **Evaluación de Optativos Deportivos**
**¿Los Optativos Deportivos tienen nota o calificación?**

✅ **Sistema de Evaluación:**
• **Modalidad:** Aprobado/Reprobado (sin calificación numérica)
• **Criterio:** Participación y asistencia (mínimo 75%)
• **Registro:** Se incluye en expediente académico
• **No afecta:** Promedio general de notas

🎯 **Requisitos para Aprobar:**
• **Asistencia mínima:** 75% de las clases
• **Participación activa** en todas las sesiones
• **Cumplimiento** del reglamento deportivo
• **Evaluación:** Basada en compromiso y progreso

📋 **Importante:**
• NO tiene calificación de 1.0 a 7.0
• SÍ aparece en certificado de notas como "Aprobado"
• Obligatorio para graduación (según malla curricular)
