---
id: general_Servicios_Digitales_Plaza_Norte_2025
source: Servicios_Digitales_Plaza_Norte_2025.txt
...
prioridad: media
tipo_contenido: faq
titulo: EXPANSIÓN MASIVA DE SERVICIOS DIGITALES
---
...
## EXPANSIÓN MASIVA DE SERVICIOS DIGITALES

### Recursos Digitales Internacionales
- Acceso a plataformas globales de aprendizaje, bibliotecas digitales y bases de datos internacionales.
- Certificaciones digitales y cursos online de instituciones extranjeras.

### Innovación y Tecnología Digital
- Integración de inteligencia artificial en servicios estudiantiles y académicos.
- Plataformas de simulación, realidad aumentada y laboratorios virtuales.
- Herramientas colaborativas y de productividad digital.

### Comunidad Digital y Colaboración
- Foros, redes sociales institucionales y espacios de colaboración online.
- Eventos digitales, hackathons y competencias internacionales.

### Alianzas y Convenios Digitales
- Convenios con empresas tecnológicas, universidades y organismos internacionales.
- Acceso a software especializado y licencias educativas globales.

### Instructivos Avanzados
- Guías multimedia para uso de plataformas, gestión de cuentas y acceso remoto.
- Manuales para autogestión de servicios digitales y resolución de problemas técnicos.
[3 lines of pre-context]
...
**Para más información y recursos actualizados, revisa los enlaces oficiales y redes sociales institucionales.**
# 🌐 SERVICIOS DIGITALES Y TECNOLÓGICOS PLAZA NORTE

## 💻 **PORTAL ESTUDIANTE PRINCIPAL**
...
### **Servicios Disponibles en Portal**
📊 **Notas y calificaciones** en tiempo real
📅 **Horarios personalizados** por semestre
📚 **Materiales de clase** descargables
💰 **Estado financiero** y pagos pendientes
📜 **Certificados online** (descarga inmediata)
🎓 **Malla curricular** y avance académico
📞 **Información de contacto** actualizada

## 🎓 **PLATAFORMA EDUCATIVA (AULA VIRTUAL)**

### **Blackboard Learn Ultra**
🌐 **URL**: https://plataforma.duoc.cl
👤 **Acceso**: Automático al ingresar credenciales
📱 **App**: "Blackboard" en stores

### **Funcionalidades Principales**
📚 **Cursos virtuales** por asignatura
📝 **Entrega de tareas** y proyectos
💬 **Foros de discusión** con compañeros y docentes
🎬 **Clases grabadas** disponibles 24/7
📊 **Calificaciones** con retroalimentación
📁 **Recursos descargables** (PDF, videos, presentaciones)
🔔 **Notificaciones** de actividades pendientes

### **Modalidades Educativas**
🏫 **Presencial**: Apoyo digital a clases físicas
💻 **Online**: Clases 100% virtuales
🔀 **Híbrido**: Combinación presencial/virtual

## 📧 **CORREO INSTITUCIONAL**

### **Configuración Email Duoc**
📧 **Formato**: nombre.apellido@duocuc.cl
🌐 **Acceso web**: https://outlook.office.com
📱 **Apps móviles**: Outlook iOS/Android
💾 **Almacenamiento**: 50GB por estudiante

### **Servicios Office 365**
📝 **Word Online**: Edición de documentos
📊 **Excel Online**: Hojas de cálculo
📽️ **PowerPoint Online**: Presentaciones
☁️ **OneDrive**: 1TB almacenamiento en nube
👥 **Teams**: Videollamadas y colaboración
📅 **Calendar**: Gestión de horarios

### **Configuración en Dispositivos**
📱 **Móvil**: Configuración automática
💻 **PC/Mac**: Acceso vía navegador o app
🔐 **Autenticación**: Doble factor disponible

## 📱 **WIFI INSTITUCIONAL**

### **Redes Disponibles**
🌐 **DUOC-Estudiantes**: Red principal estudiantes
...
📧 **Comprobantes**: Envío automático por email

### **Portal Duoc Online**
🌐 **URL**: https://www.duoc.cl/bienvenida-duoc-online/
🎓 **Para estudiantes** modalidad online
📚 **Recursos especializados**:
- Inducción a modalidad virtual
...
🌐 **Conectividad WiFi**
📱 **Apps móviles** (instalación y uso)
🔑 **Recuperación de contraseñas**
📊 **Problemas con notas** o certificados

### **Centro de Ayuda Online**
🌐 **URL**: https://centroayuda.duoc.cl/hc/es-419
📚 **Base de conocimiento** con +500 artículos
🔍 **Buscador** de problemas frecuentes
🎬 **Videos tutoriales** paso a paso

### **Artículos Más Consultados**
1. **Cómo recuperar mi contraseña**
2. **Configurar email en móvil**
3. **Acceder a notas en portal**
4. **Descargar certificados online**
5. **Conectar a WiFi DUOC**

## 💻 **LABORATORIOS DE COMPUTACIÓN**

### **Equipamiento Disponible**
🖥️ **+120 computadores** en 5 laboratorios
🖨️ **Impresoras** en cada laboratorio
📡 **Proyectores** y sistemas de audio
🔌 **Puntos de carga** para dispositivos

### **Software Instalado**
💼 **Productividad**: Office 365, Google Workspace
💻 **Programación**: Visual Studio, Eclipse, NetBeans, Python
📊 **Análisis**: SPSS, R Studio, Tableau
🎨 **Diseño**: Adobe Creative Suite (licencia educativa)
🌐 **Navegadores**: Chrome, Firefox, Edge
🔧 **Especializado**: Según carrera (base de datos, simuladores)

### **Horarios y Reservas**
📅 **Lunes a Viernes**: 8:00-21:00
📅 **Sábados**: 8:00-14:00
📝 **Reservas**: Via portal estudiante
👥 **Capacidad**: 30 estudiantes por laboratorio

## 📱 **APLICACIONES MÓVILES OFICIALES**

### **App Duoc UC**
📱 **Descarga**: 
- iOS: App Store "Duoc UC"
- Android: Play Store "Duoc UC"

🎯 **Funciones principales**:
- Acceso rápido a portal estudiante
- Push notifications de notas
- Horarios offline
- Directorio de contactos
- Mapa del campus
- Noticias institucionales

### **App Microsoft Outlook** (Email)
📧 **Para email** institucional @duocuc.cl
🔔 **Notificaciones** de correos importantes
📅 **Calendario** integrado con horarios

### **App Blackboard** (Aula Virtual)
🎓 **Acceso completo** a cursos virtuales
...
👤 **Usuario**: Número de alumno (ej: 123456789)
🔑 **Contraseña**: Asignada en matrícula (modificable)
🔐 **Doble factor**: Recomendado para mayor seguridad

### **Gestión de Contraseñas**
🌐 **Portal**: https://www.duoc.cl/alumnos/servicios-digitales/cuentas-y-accesos/
🔄 **Cambio de contraseña**: Cada 90 días (recomendado)
📧 **Recuperación**: Via email de respaldo

### **Política de Uso**
✅ **Uso exclusivo académico**
❌ **Prohibido compartir credenciales**
🚫 **No usar para actividades comerciales**
🔒 **Cerrar sesión** en equipos compartidos

## 📊 **ESTADÍSTICAS DE USO**

### **Usuarios Activos**
👥 **Portal Estudiante**: 98% estudiantes activos
📚 **Plataforma virtual**: 95% uso semanal
📧 **Email institucional**: 85% uso diario
🌐 **WiFi campus**: 1,500 conexiones diarias promedio

### **Disponibilidad del Servicio**
⏰ **Portal**: 99.9% uptime
💻 **Plataforma educativa**: 99.8% uptime
🌐 **WiFi**: 99.5% uptime
📧 **Email**: 99.9% uptime
