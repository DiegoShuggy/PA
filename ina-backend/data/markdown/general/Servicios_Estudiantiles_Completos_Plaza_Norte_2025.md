---
id: general_Servicios_Estudiantiles_Completos_Plaza_Norte_2025
source: Servicios_Estudiantiles_Completos_Plaza_Norte_2025.txt
...
**Para más información y recursos actualizados, revisa los enlaces oficiales y redes sociales institucionales.**
# SERVICIOS ESTUDIANTILES PLAZA NORTE 2025 - INFORMACIÓN COMPLETA
# Fuente: Documentación oficial y web Duoc UC - Actualizada Noviembre 2025
...
- **Importante**: Llamar para coordinar atención médica

---

## 🎫 TNE - INFORMACIÓN OFICIAL ACTUALIZADA

### **Información General**
- **Administrado por**: JUNAEB (proceso externo)
- **Duoc UC**: Intermediario para gestión
- **Información**: Vía correo institucional @duocuc.cl
- **Web oficial TNE**: http://www.tne.cl/

### **Procesos TNE**

#### **🆕 Primera TNE (Nuevos en Educación Superior)**
- **Costo**: Según informado en caja de sede
- **Pago**: Cualquier sede Duoc UC
- **Fotografía**: Online en https://capturadortne.cl/
- **Seguimiento**: https://sistema.tne.cl/reposiciones/estado_tarjeta_alumno

#### **🔄 Revalidación Anual**
- Para estudiantes que ya tienen TNE de años anteriores

#### **🆘 Reposición (Pérdida/Robo/Daño)**
- **Documentos**: Cédula, certificado alumno regular, comprobante pago
- **Autogestión**: Disponible en sucursales RM
...
Apoyo financiero para situaciones imprevistas.

#### **Categorías de Apoyo:**
1. **🩺 Gastos Médicos de Alto Costo**
2. **✝️ Gastos por Fallecimiento de Familiar**
3. **🚪 Gastos por Daños a la Vivienda**
4. **🙏 Apoyo Excepcional** (una vez por carrera)

#### **Documento Común Requerido:**
...
- **10 talleres específicos** por escuela
- **13 laboratorios específicos** por escuela
- **14 laboratorios de computación**
- **Auditorio**: 200 m2 para 150 personas

### **Características Generales**
- **Superficie total**: 11.656 m2 edificados
- **Capacidad**: Más de 5.000 estudiantes
- **Accesibilidad**: Accesos para personas con discapacidad
- **Ubicación estratégica**: A pasos del Mall Plaza Norte
...
- **Diurna**: Lunes a Viernes horario tradicional
- **Vespertina**: Orientada a personas que trabajan
- **Modalidades especiales**: Algunos programas incluyen sábados

### **Niveles Académicos**
- **Técnico Superior**: 2 años de duración
- **Ingeniería/Profesional**: 4 años de duración
- **Educación Continua**: Programas de especialización
...
### **Alimentación**
- **Casino interno**: Menús variados para estudiantes
- **Espacios**: Comedores y áreas de descanso
...
### **Tecnología**
- **WiFi institucional** en toda la sede
- **Laboratorios especializados** por carrera
- **Equipamiento moderno**

---

## 🔗 RECURSOS DIGITALES Y PORTALES

### **Portales Estudiantiles**
- **Portal Estudiantes**: Acceso a notas, horarios, certificados
- **Plataforma VIVO**: Material de clases y evaluaciones
- **Correo Institucional**: @duocuc.cl

### **Autogestión Digital**
- **Certificados online**: Disponibles las 24 horas
...
- **Referencia**: A pasos del Mall Plaza Norte
- **Región Metropolitana**

### **Acceso en Transporte Público**
- **Metro**: Líneas conectadas via transbordo
- **Buses**: Múltiples líneas que llegan a Plaza Norte
- **Conectividad**: Excelente conexión con Santiago
...
- **Correo institucional**: Principal vía de comunicación
- **Sitio web**: https://www.duoc.cl/sedes/plaza-norte/
- **Avisos**: Publicados en portales oficiales

### **Trámites y Procedimientos**
- **Presenciales**: En horarios de atención establecidos
- **Digitales**: Disponibles 24/7 en portales oficiales
- **Documentación**: Mantener vigencia de documentos

---

**Última actualización**: Noviembre 2025
**Fuente**: Sitio web oficial Duoc UC y documentación interna
**Validez**: Hasta nueva actualización oficial
