...
import Profile from '../img/DeportesCAF.jpg';
import Profile2 from '../img/DeportesJefe.jpg';
...
export function Deportes() {
    ...
    return (
        <div className="Asuntos-container">
            ...
            <div className='Perfil-container'>
                ...
                <div className='descripcion-container'>
                    ...
                    <p className='desc'>
                        ...
                        <h2 className='tiutlo'>{t('Deportes.Desctitle')}</h2>
            ...
            <h2 className='tiutlo'>{t('Deportes.FAQTiltle')}</h2>
